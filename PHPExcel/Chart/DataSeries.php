...
class PHPExcel_Chart_DataSeries
{
    ...
    public $customStyle = array(
        'lineWidth' => 12700, // 折线图线宽
        'barGapWidth' => 150, // 柱状图柱子间隔
        'fontSize' => null, // 字体大小 1000
        'hide_label_border' => false, // 是否隐藏标签边框
        'multi_series_with_secondary' => false, // 是否使用多系列且使用了次轴（在主轴标记）
    );
